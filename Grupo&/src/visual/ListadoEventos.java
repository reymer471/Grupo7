...
public class ListadoEventos extends JDialog {
            ...
            panel.setLayout(new BorderLayout(0, 0));
            {
                ...
                panel_1.setLayout(new BorderLayout(0, 0));
                {
                    ...
                    panel_1.add(scrollPane, BorderLayout.CENTER);
                    {
                        ...
                        String[] identificadores = { "Código", "Título", "Tipo", "Fecha", "Duración", "Capacidad" };
                ...
                eliminarBtn.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        respuesta = JOptionPane.showConfirmDialog(null,
                                "¿Estás seguro de que quieres eliminar este evento?", "Confirmación",
                        ...
                        if (respuesta == JOptionPane.YES_OPTION) {
                            ...
                            if (evento != null) {
                                ...
                                loadEventos(); // Actualiza la tabla después de eliminar
                            }
                        }
                    }
                });
    ...
    private void loadEventos() {
        ...
        if (SPEC.getInstance().getMisEventos() == null || SPEC.getInstance().getMisEventos().isEmpty()) {
            JOptionPane.showMessageDialog(this, "No hay eventos para mostrar.", "Información", JOptionPane.INFORMATION_MESSAGE);
            return;
        }

        row = new Object[6]; // Asegúrate de que el tamaño coincida con las columnas
